    ...
    <div class="content-header row align-items-center m-0">
        ...
        <nav aria-label="breadcrumb" class="col-sm-4 order-sm-last mb-3 mb-sm-0 p-0 ">
            <ol class="breadcrumb d-inline-flex font-weight-600 fs-13 bg-white mb-0 float-sm-right">
                ...
                @endif
                <li style="margin-left: 13px;"><a class="btn btn-info"
                    ...
                    <div class="col-md-12">
                        <div class="card" style="box-shadow:0 4px 8px 0 rgba(0, 0, 0, 0.2);height:250px;">
                            <div class="card-body">
                                ...
                                @if (auth()->user()->role_id == 11)
                                    <!-- Modal -->
                                    <div class="modal fade" id="addanotherpartner" tabindex="-1" role="dialog"
                                        aria-labelledby="exampleModalLabel4" aria-hidden="true">
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                <form id="addonpartner" method="post"
                                                    action="{{ url('otherpatner/update') }}"
                                                    enctype="multipart/form-data">
                                                    @csrf
                                                    <div class="modal-header" style="background:#37A000;color:white;">
                                                        <h5 class="modal-title font-weight-600" id="exampleModalLabel4">
                                                            Add
                                                            Other Partner</h5>
                                                        <div>
                                                            <ul>
                                                ...
                                                <form id="addonpartner" method="post"
                                                    ...
                                                    <div class="modal-body">
                                                        <div class="details-form-field form-group row">
                                                            <div class="col-12">
                                                                <div class="form-group">
                                                                    <label class="font-weight-600">Other Partner
                                                                    </label>
                                                                    <select required class="language form-control"
                                                                        id="exampleFormControlSelect1"
                                                                        name="otherpatnerid">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="card-head">
                                        ...
                                        @if (auth()->user()->role_id == 11)
                                            ...
                                            <b>
                                                <a data-toggle="modal" data-target="#addanotherpartner"
...
<script>
    $(document).ready(function() {
        ...
        $('#addanotherpartner').on('hidden.bs.modal', function() {
            $('#addonpartner')[0].reset();
        });
    });
</script>
