...
class DashboardReport extends Controller
{
    ...
    public function exceptionalexpenses(Request $request)
    {
        ...
        // filter total amount of convence, how many amount approved for convence in this months or Other Expenses
        ...
        // $total3 = $sharedData->sum('amount') ?? 0;



        $totalspend = ($total1 ?? 0) + ($total2 ?? 0);

        return view('backEnd.dashboardreport.otherspend', compact('totalspend', 'outstationData', 'outstationDatas'));
    }
