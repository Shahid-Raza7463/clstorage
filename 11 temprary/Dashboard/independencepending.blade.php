                    ...
                    <table id="examplee" class="display nowrap">
                        <thead>
                            <tr>
                                ...
                                <th>İndependent/Not İndependent</th>
                        ...
                        <tbody>
                            @foreach ($clientspecificindependencedeclaration as $independenceData)
                                ...
                                <tr>
                                    ...
                                    <td>
                                        @if ($independencescount)
                                            @php
                                                $independencesArray = (array) $independencescount;
                                            @endphp
                                    ...
                                    {{-- <td>
                                        @if ($independences != null)
                                            {{ date('F d,Y', strtotime($independences->created_at)) }}
                                        @endif
                                    </td> --}}
                            ...
                            @foreach ($clientspecificindependencedeclaration as $independenceData)
                                @php
                                    ...
                                    $independencescount = DB::table('independences')
                                        ->where('assignmentgenerate_id', $independenceData->assignmentgenerate_id)
                                        ->where('createdby', $independenceData->id)
                                        ->first();
                                    //d($independences);
